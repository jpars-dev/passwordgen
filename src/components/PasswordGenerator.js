  ...
  return (
    <div ref={containerRef} className="generator-container" style={{ opacity: 0 }}>
      ...
      <header className="site-header">
        <a href="https://jpars.dev" target="_blank" rel="noopener noreferrer" className="site-brand">
          <MorphingLogo size={38} />
          <img src="/jparsdev-logo.svg" alt="jpars.dev" className="site-logo-wordmark" />
        </a>
        ...
        <div className="modal-overlay" onClick={() => setShowAbout(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-header">
              <MorphingLogo size={42} />
              <img src="/jparsdev-logo.svg" alt="jpars.dev" className="modal-logo-wordmark" />
            </div>
            ...
            <div className="modal-links">
              ...
              <a href="https://jpars.dev" target="_blank" rel="noopener noreferrer" title="Website">
